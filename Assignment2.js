...
//(0°C × 9/5) + 32 = 32°F
let tempinPut = 0;
let tempinFh = (tempinPut * 9 / 5) + 32; //(0°C × 9/5) + 32 = 32°F
let tempinCelc = (tempinPut - 32) * 5 / 9; //(32°F − 32) × 5/9 = 0°C
let tempinKlvn = (tempinPut * 5 / 9) + 459.67; //    (T)K = 5/9 (T)F + 459.67.
...
let countvalue = 210;
let totalValue = 300;
let percentageValue = (countvalue / totalValue) * 100;
...
// 3 days.
let inputValue = 75;
let days = inputValue % 7;
let weeks = inputValue / 7;
let roundedweeks = Math.floor(weeks);
...
let priceValue = 90;
let discount10 = 10 / 100;
let discount5 = 5 / 100;
if (priceValue >= 100) {
    let discountValue = priceValue * discount10;
    console.log("The Discounted Price of the Product is", priceValue - discountValue);
}
else if (priceValue < 100) {
    let discountValue = priceValue * discount5;
    console.log("The Discounted Price of the Product is", priceValue - discountValue);
}
...
if (daynumber == 1) {
    ...
    console.log("Enter Number of days between 1-7 only");
}
...
var inputUnits = 550;
var rate = 35;
var billAmount = (inputUnits * rate);
var tax1 = 10 / 100;
var tax2 = 15 / 100;
var tax3 = 20 / 100;
var tax4 = 25 / 100;
if (inputUnits > 500) {
    let taxAmount = billAmount * tax4;
    let totalBillAamount = taxAmount + billAmount;
